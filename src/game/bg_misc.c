...
buildableAttributes_t bg_buildableList[ ] =
{
  ...
  },
  {
    ...
    0,                     //int       creepSize;
    qfalse,                //qboolean  dccTest;
    qtrue,                //qboolean  transparentTest; //test
    qfalse,                //qboolean  reactorTest;
    qtrue,                 //qboolean  replacable;
  },
  {
...
classAttributes_t bg_classList[ ] =
{
  ...
  },
  {
    ...
    { PCL_ALIEN_LEVEL4, PCL_ALIEN_LEVEL3_UPG, PCL_HUMAN_BSUIT },   //int     children[ 3 ];
  ...
  },
  {
    ...
    { PCL_HUMAN_BSUIT, PCL_NONE, PCL_NONE },               //int     children[ 3 ];
  ...
  },
  {
    ...
    1.0f,                                           //float   bobCycle;
    100,                                            //int     steptime;
    SPY_SPEED,                                           //float   speed;
    10.0f,                                          //float   acceleration;
    1.0f,                                           //float   airAcceleration;
    5.0f,                                           //float   friction;
    100.0f,                                         //float   stopSpeed;
    370.0f,                                         //float   jumpMagnitude;
    1.0f,                                           //float   knockbackScale;
    { PCL_NONE, PCL_NONE, PCL_NONE },               //int     children[ 3 ];
    SPY_COST,                                              //int     cost;
    SPY_VALUE                                               //int     value;
...
weaponAttributes_t bg_weapons[ ] =
{
  ...
  },
  {
    ...
    LEVEL3_BOUNCEBALL_AMMO,      //int       maxAmmo;
    0,                    //int       maxClips;
    qtrue,                //int       infiniteAmmo;
    qfalse,               //int       usesEnergy;
...
float BG_FindPercentAmmo( weapon_t weapon, int stats[], int psAmmo[], int psAmmo2[] ) {
    int maxAmmo, maxClips;
    int ammo, clips;
