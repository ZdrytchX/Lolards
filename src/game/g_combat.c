...
G_Say(attacker,NULL, SAY_ALL, "^4H^5umans ^3are ^1obsolete^3, we shall ^1rule Tremulous");
...
#define VAMP (( attacker->client->ps.stats[ STAT_MAX_HEALTH ] + VAMP_EXTRA) * take * VAMP_TAKE_MULTIPLIER + 1); // supports health gain that is less than 1 value and the '+50' means porportionate to health + 50. Its also to help dretches and small ones gain health.
/* //cancel
